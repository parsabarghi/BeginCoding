...
app = Flask(__name__) # Flask configing 
# Config our sqlalchemy and database 
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///database.db'
db = SQLAlchemy(app)
api = Api(app) # config our api

# making tabel and our database
...
@app.route('/') # first page or our first route
def home():
